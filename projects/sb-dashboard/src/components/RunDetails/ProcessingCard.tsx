          ...
          {isProcessing && (
            ...
            >
              ...
              >
                ...
                >
                  <button
                    onClick={() => handleUpdateWorkers("crop", -1)}
                    className="btn btn-sm btn-secondary"
                  >
                    -
                  </button>
                  ...
                  >
                    {processingProgress.active_crop_workers ?? 0}
                  </span>
                  <button
                    onClick={() => handleUpdateWorkers("crop", 1)}
                    className="btn btn-sm btn-secondary"
              ...
              >
                ...
                >
                  <button
                    onClick={() => handleUpdateWorkers("detect", -1)}
                    className="btn btn-sm btn-secondary"
                  >
                    -
                  </button>
                  ...
                  >
                    {processingProgress.active_detect_workers ?? 0}
                  </span>
                  <button
                    onClick={() => handleUpdateWorkers("detect", 1)}
                    className="btn btn-sm btn-secondary"
            ...
            {STAGE_ORDER.map((name) => {
              ...
              return (
                ...
                >
                  ...
                  >
                    {stage.fps ? `${stage.fps.toFixed(1)} fps` : "--"}
                  </div>
                  <div
                    style={{
                      textAlign: "right",
                  ...
                  >
                    {stage.ms_per_frame > 0
                      ? `${stage.ms_per_frame.toFixed(1)}ms`
                      : "--"}
                  </div>
                </div>
              );
