...
import { Info, Video, Users, Sun, Moon, Tag, Calendar } from "lucide-react";
...
interface PropertiesCardProps {
    ...
    editLightTeamName: string;
    setEditLightTeamName: (val: string) => void;
    editDarkTeamName: string;
    setEditDarkTeamName: (val: string) => void;
    editTags: string;
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                ...
                <div className="list-item">
                    ...
                    {isEditing ? (
                        ...
                        <div style={{ fontWeight: 500, fontSize: "0.875rem" }}>
                            {run.run_context.light_team_name}
                        </div>
                    )}
                </div>
                ...
                <div className="list-item">
                    ...
                    {isEditing ? (
                        ...
                        <div style={{ fontWeight: 500, fontSize: "0.875rem" }}>
                            {run.run_context.dark_team_name}
                        </div>
                    )}
                </div>
                    ...
                    {isEditing ? (
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                            <input
                                ...
                                onChange={(e) => setEditSampleRate(parseFloat(e.target.value) || 0)}
                            />
                            <span style={{ fontSize: "0.875rem", color: "var(--text-muted)" }}>FPS</span>
                        </div>
                    ) : (
                        <div style={{ fontWeight: 500, fontSize: "0.875rem" }}>
